...
public class GetAListOfJoinedRoomsServiceTest {
    
    @Mock Database database;
    
    @InjectMocks
    GetAListOfJoinedRoomsService getAListOfJoinedRoomsService = new GetAListOfJoinedRoomsService( );
    ...
    public void shouldReturnAListOfRooms( ) {
        ...
        List<Room> roomsFromService = getAListOfJoinedRoomsService.getList( user );
    ...
    public void shouldReturnAListOfStrings( ) {
        ...
        List<String> stringListFromService = getAListOfJoinedRoomsService.getAStringListOfJoinedRooms( user );
